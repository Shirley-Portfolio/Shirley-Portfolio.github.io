...
export const projectsData: Project[] = [
    ...
    {
    title: 'GPS-Denied Navigation System for Orb-Based Drones',
    description:
      'Developed a robust navigation system for compact, Air Force-funded orb-based drones operating in GPS-denied environments, focusing on sensor integration and control loops.',
    date: 'December 2025',
  ...
  return (
    <div id="projects" className="mx-auto mt-56 max-w-7xl px-4 py-16">
      <SectionHeading
        ...
        subheading="A collection of my most Impactful work"
      />
